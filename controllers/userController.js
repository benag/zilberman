...
class userController {
    ...
    async sendSMS (req) {
        ...
        await this.sql.query(`update tUsersAndRoles set uSmsCode = ${randomNum}, smsCreatedAt = ${Date.now()} where uPhone=${req.body.phone}`);
        let returnSMS = await nexmo.sms(req.body.phone, 'הכנס קוד: ' + randomNum);
